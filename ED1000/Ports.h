...
DEFPORTOUT		(SV_EIN,	C, 2) 	// 	25	Ausgang für Zusatzschaltung zur Stromversorgung des Fernschreibers
DEFPORTINPULLAL	(TASTEEXT,	C, 3) 	// 	26  Eingang für externe Taste zur Aktivierung
//							C, 4)	//	27	SDA
//							C, 5)	//	28	SCL
