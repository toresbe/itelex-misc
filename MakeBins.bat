...
call MakeBin1.bat itlx_Messgeraet-EN Messgeraet\EN\Messgeraet.hex Mega168_Quarz
...
call MakeBin1.bat itlx_SeriellUndSpeicher2-EN SeriellUndSpeicher\PlatVer21-EN\SeriellUndSpeicher.hex Mega168_Quarz
