...
#ifdef PROGIDZUSATZ
PROGMEM const char Identifier[] = "___itlx_LeitungAnalog2-" PROGIDZUSATZ "___" __DATE__ "___" __TIME__ "___" SVNVERSION "___";
	//!< Identifier im Programmspeicher.
#else
PROGMEM const char Identifier[] = "___itlx_LeitungAnalog2___" __DATE__ "___" __TIME__ "___" SVNVERSION "___";
	//!< Identifier im Programmspeicher.
#endif
