...
DEFPORTOUT		(FS_AKTIV,	D, 7) // Einschaltung (Ausgabe, Motor-Schalter)
DEFPORTINPULL	(FS_EING, 	D, 6) // Strom-Einlesung

DEFPORTOUT		(LESER_EIN,	B, 5) // Ausgang für Zusatzschaltung zur Stromversorgung des Fernschreibers
