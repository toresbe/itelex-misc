...
<<<<<<< .mineC:\WinAVR-20100110\avr\bin\objcopy.exe -I ihex -O binary ..\Messgeraet\default\Messgeraet.hex .\TxP2_Messgeraet.bin
...
=======>>>>>>> .theirsC:\WinAVR-20100110\avr\bin\objcopy.exe -I ihex -O binary ..\UniversalIF\RS232-Hex\UniversalIF.hex .\TxP2_UniIF-RS232-Hex.bin
